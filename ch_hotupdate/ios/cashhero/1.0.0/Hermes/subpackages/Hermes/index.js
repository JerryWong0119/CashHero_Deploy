  ...
  Hermes_BonusReel: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      SetBonusReel: function SetBonusReel(idxs, items, restCnt, fullCnt, isInitWing) {
        ...
        var m = [];
        Array.isArray(idxs) && (m = idxs);
        var _iterator = _createForOfIteratorHelper(m), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            var bs = [];
            Array.isArray(_bonus_Symbol.children) && (bs = _bonus_Symbol.children);
            var _iterator2 = _createForOfIteratorHelper(bs), _step2;
            try {
      ...
      showKuang: function showKuang() {
        ...
        var rowArr = [];
        var ti = [];
        Array.isArray(idxs) && (ti = idxs);
        var _iterator3 = _createForOfIteratorHelper(ti), _step3;
        try {
      ...
      StartMove: function StartMove() {
        ...
        if (this._restCnt >= 0 && idxs && this._fullCnt - 1 === idxs.length) {
          ...
          var ti = [];
          Array.isArray(idxs) && (ti = idxs);
          var _iterator4 = _createForOfIteratorHelper(ti), _step4;
          try {
          ...
          var da = [];
          Array.isArray(dataArr) && (da = dataArr);
          var _iterator5 = _createForOfIteratorHelper(da), _step5;
          try {
      ...
      showSmallWing: function showSmallWing(type) {
        ...
        if (this._restCnt <= 0) {
          ...
          var _iterator6 = _createForOfIteratorHelper(holderNode.children), _step6;
          try {
    ...
    cc.Class({
      ...
      SetSlotsResult: function SetSlotsResult(cards) {
        ...
        for (var i = 0; i < cards.length; i++) {
          ...
          if (this._cfg.symbol[cards[i]]) {
            ...
            res.data = {};
            if (jadeInfo) {
              var idx1 = jadeInfo && jadeInfo.idxs;
              Array.isArray(idx1) || (idx1 = []);
              var index = idx1.indexOf(i + 1);
              if (index >= 0) {
            ...
            if (currGoldIngotInfo) {
              var idx2 = currGoldIngotInfo && currGoldIngotInfo.idxs;
              Array.isArray(idx2) || (idx2 = []);
              var _index = idx2.indexOf(i + 1);
              if (_index >= 0) {
            ...
            var gid = [];
            Array.isArray(goldIngotInfo) && (gid = goldIngotInfo);
            var _iterator = _createForOfIteratorHelper(gid), _step;
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                var iterator = _step.value;
                var idx = iterator && iterator.idxs;
                Array.isArray(idx) || (idx = []);
                var _index2 = idx.indexOf(i + 1);
                if (_index2 >= 0) {
      ...
      collectJade: function collectJade() {
        ...
        return _asyncToGenerator(regeneratorRuntime.mark(function _callee16() {
          var GameData, jadeStore, ti, _iterator3, _step3, iterator;
            ...
            while (1) switch (_context16.prev = _context16.next) {
             case 0:
              ...
              if (_this8._gameInfo.jadeInfo && _this8._gameInfo.jadeInfo.idxs.length > 0) {
                ti = [];
                Array.isArray(_this8._gameInfo.jadeInfo.idxs) && (ti = _this8._gameInfo.jadeInfo.idxs);
                _iterator3 = _createForOfIteratorHelper(ti);
                try {
                  for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
      ...
      sortCollectWing: function sortCollectWing() {
        ...
        var rgii = [];
        Array.isArray(this._reelGoldIngotInfos) && (rgii = this._reelGoldIngotInfos);
        var _iterator4 = _createForOfIteratorHelper(rgii), _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
