    ...
    cc.Class({
      ...
      playSpine: function playSpine(node) {
        ...
        return new Promise(function(success) {
          if (node) {
            node.active = true;
            console.log("\u64ad\u653e\u8282\u70b9[" + node.parent.name + "/" + node.name + "]\u7684spine\u52a8\u4f5c: " + animationName);
                  ...
                  return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                     ...
                     case 26:
                      ...
                      console.log("\u7b2c\u4e00\u6b21\u9009\u62e9", _this8._currRound, _this8._totalRound);
                     ...
                     case 35:
                      console.log("\u7b2c\u4e00\u6b21\u9009\u62e9---\u7ed3\u675f", _this8._currRound, _this8._totalRound);
                     ...
                     case 36:
                      ...
                      console.log("\u9009\u62e9\u4e00\u8f6e\u5f00\u59cb", _this8._currRound, _this8._totalRound);
                     ...
                     case 46:
                      console.log("\u9009\u62e9\u4e00\u8f6e\u7ed3\u675f", _this8._currRound, _this8._totalRound);
                     ...
                     case 47:
                      ...
                      console.log("\u4e00\u8f6e\u7ed3\u7b97", _this8._currRound, _this8._totalRound);
                      _context3.next = 51;
                     ...
                     case 59:
                      console.log("\u5927\u7ed3\u7b97", _this8._currRound, _this8._totalRound);
                      _context3.next = 62;
