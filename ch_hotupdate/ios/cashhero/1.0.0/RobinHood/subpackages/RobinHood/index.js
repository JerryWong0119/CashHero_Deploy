    ...
    cc.Class({
      ...
      _processMapFreeData: function _processMapFreeData(freeGameSlots) {
        ...
        for (var i = 0; i < freeGameSlots.length; i++) {
          ...
          zjLuXian = Array.isArray(zjLuXian) ? zjLuXian : zjLuXian && "object" === _typeof(zjLuXian) ? Object.values(zjLuXian) : [];
  ...
  RobinHood_Slots: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      SetSlotsResult: function SetSlotsResult(cards) {
        ...
        if (bonusItem) {
          var bi = [];
          Array.isArray(bonusItem) && (bi = bonusItem);
          var _iterator = _createForOfIteratorHelper(bi), _step;
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      SetReelStateInfo: function SetReelStateInfo(cards) {
        ...
        var rsi = [];
        Array.isArray(this._cfg.reelStateInfo) && (rsi = this._cfg.reelStateInfo);
        var _iterator2 = _createForOfIteratorHelper(rsi), _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
      ...
      ShowWinTrace: function ShowWinTrace() {
        ...
        if (this._gameInfo.scatterZJLuXian && this._gameInfo.scatterZJLuXian.indexs) {
          ...
          var _idx = this._gameInfo && this._gameInfo.scatterZJLuXian && this._gameInfo.scatterZJLuXian.indexs;
          Array.isArray(_idx) || (_idx = []);
          skipBorderAniIdxs = _idx.concat();
        }
        var needSkipAniIdxs = [];
      ...
      setReelStopState: function setReelStopState(idx, boo) {
        ...
        var rs = [];
        Array.isArray(reel._reelState) && (rs = reel._reelState);
        var _iterator3 = _createForOfIteratorHelper(rs), _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
      ...
      toNormalState: function toNormalState() {
        ...
        var r = [];
        Array.isArray(this._reels) && (r = this._reels);
        var _iterator4 = _createForOfIteratorHelper(r), _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
      ...
      toWheelFreeState: function toWheelFreeState() {
        ...
        var r = [];
        Array.isArray(this._reels) && (r = this._reels);
        var _iterator5 = _createForOfIteratorHelper(r), _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
      ...
      toWheelBonusState: function toWheelBonusState() {
        ...
        var r = [];
        Array.isArray(this._reels) && (r = this._reels);
        var _iterator6 = _createForOfIteratorHelper(r), _step6;
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
      ...
      resetAllSymbol: function resetAllSymbol() {
        var r = [];
        Array.isArray(this._reels) && (r = this._reels);
        var _iterator7 = _createForOfIteratorHelper(r), _step7;
        try {
