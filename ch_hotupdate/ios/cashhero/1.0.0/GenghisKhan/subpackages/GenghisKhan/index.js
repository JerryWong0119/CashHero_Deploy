...
GenghisKhan_Bottom: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "9d725QqRD1Bo4Df+O8u17Sp", "GenghisKhan_Bottom");
cc.Class({
...
GenghisKhan_Cfg: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "d333aTKKshGy5NQ9GPlTlCw", "GenghisKhan_Cfg");
var o;
function a(e, t, n) {
...
GenghisKhan_CollectNode: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "204b3lNCfJMVJ0dSDIXJPKF", "GenghisKhan_CollectNode");
function o(e, t, n, o, a, i, s) {
try {
var r = e[i](s), c = r.value;
} catch (e) {
n(e);
return;
}
...
for (var e = 1; e < 7; e++) {
var t = cc.find("point" + e, this.node);
...
setCollectData: function(e, t) {
this._needBet = t;
this._pointIndex = e.count || 0;
this._maxCount = e.totalCount;
for (var n = 0; n < this._pointIndex; n++) {
var o = this._pointList[n];
cc.find("select", o).active = !0;
}
this.initCollectNode();
this._maxCount - this._pointIndex == 1 ? this._superJL.active = !0 : this._superJL.active = !1;
},
onClickNode: function() {
if (!cc.vv.gameData.GetSlotsScript()._isInFree && "idle" == cc.vv.gameData.GetSlotState() && !(cc.vv.gameData.GetAutoModelTime() > 0) && !this._tips.active && this._needBet <= cc.vv.gameData._deskInfo.mults.length) {
if (cc.vv.gameData.GetBetIdx() >= this._needBet) this.showTips(); else {
...
this._suo.active = !0;
this._suo.getComponent(sp.Skeleton).setAnimation(0, "animation2", !0);
this._collectLock = !0;
}
},
...
this._collectLock = !1;
var t = this._suo.getComponent(sp.Skeleton);
...
this._collectLock = !0;
var n = this._suo.getComponent(sp.Skeleton);
...
case 0:
if (!(cc.vv.gameData.GetBetIdx() < t._needBet)) {
n.next = 3;
break;
}
...
case 3:
t._pointIndex++;
t._pointIndex > t._maxCount && (t._pointIndex = t._maxCount);
o = t._pointList[t._pointIndex - 1];
a = o.convertToWorldSpaceAR(cc.v2(0, 0));
i = cc.vv.gameData.getManage()._collectFree.convertToNodeSpaceAR(a);
for (s = 0; s < e.length; s++) {
r = e[s];
(c = cc.vv.gameData.GetSlotsScript().GetSymbolByIdx(r)) && function() {
var e = c.node.convertToWorldSpaceAR(cc.v2(0, 0)), t = cc.vv.gameData.getManage()._collectFree.convertToNodeSpaceAR(e), n = cc.instantiate(cc.vv.gameData.GetPrefabByName("scattershouji"));
n.parent = cc.vv.gameData.getManage()._collectFree;
n.position = t;
cc.tween(n).to(.5, {
position: i
}).call(function() {
...
t._maxCount - t._pointIndex == 1 ? t._superJL.active = !0 : t._superJL.active = !1;
if (!(t._pointIndex >= t._maxCount)) {
n.next = 21;
break;
}
n.next = 17;
...
(l = t._sjt.getComponent(sp.Skeleton)).setAnimation(0, "animation2", !1);
l.addAnimation(0, "animation1", !0);
...
cc.find("select", t).active = !1;
}
this._pointIndex = 0;
this._superJL.active = !1;
}
});
cc._RF.pop();
}, {} ],
GenghisKhan_GameData: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "563e0I2jalJ9IDwfz3dQA99", "GenghisKhan_GameData");
cc.Class({
...
recoverySlot: function() {
for (var e = 0; e < this._slotsArr.length; e++) {
var t = this._slotsArr[e];
e == this._slotsIndex ? t.recovery() : t.hide();
}
},
getManage: function() {
return this._manage;
...
GenghisKhan_Logic: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "56718gFsKNEoowF1khR6MGl", "GenghisKhan_Logic");
cc.Class({
...
var a = cc.find("LMSlots_Top", t).addComponent(n.scripts.Top);
a.Init();
var i = cc.find("LMSlots_Bottom", t).addComponent(n.scripts.Bottom);
i.Init();
cc.vv.gameData.SetTopBottomScript(a, i);
var s = cc.find("slots", t).addComponent(n.scripts.Slots);
cc.vv.gameData.addSlots(s);
var r = cc.find("slotsfree", t).addComponent(n.scripts.Slots);
cc.vv.gameData.addSlots(r);
var c = cc.find("slotssuper", t).addComponent(n.scripts.Slots);
cc.vv.gameData.addSlots(c);
this.node.addComponent("LMSots_OtherSys");
n.puzzleCfg && this.node.addComponent("LMSlots_Puzzle");
var l = cc.find("Canvas/safe_node/slots").getComponentInChildren("GenghisKhan_CollectNode");
l && cc.vv.gameData.setCollectNode(l);
var u = t.getComponentInChildren("GenghisKhan_Pop");
u && cc.vv.gameData.setPopWinManage(u);
var m = t.getComponentInChildren("GenghisKhan_qiePing");
m && cc.vv.gameData.setQiePing(m);
var h = t.getComponentInChildren("GenghisKhan_bouns");
h && cc.vv.gameData.setBonus(h);
...
GenghisKhan_Pop: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "732a6T4R5lOuK+HIznjAcXp", "GenghisKhan_Pop");
function o(e, t, n, o, a, i, s) {
try {
var r = e[i](s), c = r.value;
} catch (e) {
...
t.showWin();
(s = cc.find("show_freeGameTimes", t.node)).active = !0;
(r = cc.find("times", s)).active = !1;
(c = cc.find("startButton", s)).active = !1;
(l = cc.find("freetanchuang", s)).active = !0;
(u = l.getComponent(sp.Skeleton)).setAnimation(0, "animation3", !1);
u.addAnimation(0, "animation3_1", !0);
n.next = 15;
return t.awaitTime(.5);
...
case 4:
u.setAnimation(0, "animation3_2", !1);
...
r.active = !1;
c.active = !1;
(l = cc.find("freetanchuang", s).getComponent(sp.Skeleton)).setAnimation(0, "animation1", !1);
l.addAnimation(0, "animation1_1", !0);
n.next = 13;
return t.awaitTime(.5);
...
c.getComponent(cc.Button).interactable = !0;
c.off("click");
c.on("click", a(regeneratorRuntime.mark(function n() {
return regeneratorRuntime.wrap(function(n) {
for (;;) switch (n.prev = n.next) {
case 0:
c.getComponent(cc.Button).interactable = !1;
...
case 5:
l.setAnimation(0, "animation1_2", !1);
...
t.showWin();
(i = cc.find("show_freeGame_winfree", t.node)).active = !0;
(s = cc.find("times", i)).active = !1;
(r = cc.find("freetanchuang", i).getComponent(sp.Skeleton)).setAnimation(0, "animation2", !1);
r.addAnimation(0, "animation2_1", !0);
n.next = 11;
return t.awaitTime(.5);
...
case 17:
r.setAnimation(0, "animation2_2", !1);
...
e.showWin();
(i = cc.find("show_superBonusStart", e.node)).active = !0;
(s = cc.find("startButton", i)).active = !1;
(r = cc.find("bonustanchuang", i)).active = !0;
(c = r.getComponent(sp.Skeleton)).setAnimation(0, "animation2", !1);
c.addAnimation(0, "animation2_1", !0);
t.next = 13;
...
s.off("click");
s.on("click", a(regeneratorRuntime.mark(function t() {
return regeneratorRuntime.wrap(function(t) {
for (;;) switch (t.prev = t.next) {
case 0:
...
case 4:
c.setAnimation(0, "animation2_2", !1);
...
e.showWinEx();
(a = cc.find("showBonusGame", e.node)).active = !0;
(i = cc.find("bonuskaishi", a)).active = !0;
(s = i.getComponent(sp.Skeleton)).setAnimation(0, "animation", !1);
...
showBonusGameFreeStart: function() {
var e = this;
return new Promise(function() {
var t = a(regeneratorRuntime.mark(function t(n, o) {
var a, i, s;
...
Global.SlotsSoundMgr.playEffect(Global.SlotsSoundMgr.bonus_dialog_start_show);
e.showWinEx();
(a = cc.find("showBonusGameFree", e.node)).active = !0;
(i = cc.find("bonuskaishi", a)).active = !0;
(s = i.getComponent(sp.Skeleton)).setAnimation(0, "animation", !1);
s.setCompleteListener(function() {
a.active = !1;
...
t.showWin();
(s = cc.find("show_superBonusWinCoin", t.node)).active = !0;
r = cc.find("coin", s);
c = cc.find("collectBtn", s);
r.active = !1;
c.active = !1;
(l = cc.find("bonustanchuang", s).getComponent(sp.Skeleton)).setAnimation(0, "animation1", !1);
l.addAnimation(0, "animation1_1", !0);
n.next = 13;
return t.awaitTime(.5);
...
var n = this;
return new Promise(function() {
var o = a(regeneratorRuntime.mark(function o(i, s) {
var r, c, l, u, m, h;
...
case 12:
n.showWin();
(r = cc.find("show_win_jackpot", n.node)).active = !0;
c = cc.find("coin", r);
l = cc.find("collectBtn", r);
c.active = !1;
l.active = !1;
u = cc.find("jptanchuang_di", r).getComponent(sp.Skeleton);
m = cc.find("jptanchuang_ma", r).getComponent(sp.Skeleton);
h = cc.find("jptanchuang_ban", r).getComponent(sp.Skeleton);
u.setAnimation(0, "animation" + (4 - t), !1);
u.addAnimation(0, "animation" + (4 - t) + "_1", !0);
m.setAnimation(0, "animation" + (4 - t), !1);
m.addAnimation(0, "animation" + (4 - t) + "_1", !0);
h.setAnimation(0, "animation" + (4 - t), !1);
h.addAnimation(0, "animation" + (4 - t) + "_1", !0);
o.next = 30;
...
n._startAddCoin = !0;
Global.doRoallNumEff(c, Math.floor(.1 * e), e, 2.5, function() {
n._startAddCoin = !1;
}, null, 0, !0);
l.getComponent(cc.Button).interactable = !0;
l.off("click");
l.on("click", a(regeneratorRuntime.mark(function o() {
return regeneratorRuntime.wrap(function(o) {
for (;;) switch (o.prev = o.next) {
case 0:
...
u.setAnimation(0, "animation" + (4 - t) + "_2", !1);
m.setAnimation(0, "animation" + (4 - t) + "_2", !1);
h.setAnimation(0, "animation" + (4 - t) + "_2", !1);
u.setCompleteListener(function() {
r.active = !1;
n.hideWin(function() {
i();
...
GenghisKhan_PrizePool: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "621d57knjVP85zwXW1Gdnsk", "GenghisKhan_PrizePool");
...
var t = e.node.y + e.node.height / 2 - (cc.winSize.height / 2 - 20);
e.node.y -= t;
}
}, 0);
},
...
if (s) {
var r = cc.find("Canvas/safe_node").getComponentInChildren("LMSlotMachine_PrizePool");
if (r) {
var c = cc.find("prizePool_" + s, r.node.parent);
if (c) {
var l = cc.find("lbl_num", c), u = (cc.find("spr_title", c), cc.find("liuguang", c)), m = cc.find("lockEffect", c);
if (t) {
if (!i) {
Global.SlotsSoundMgr.playEffect(Global.SlotsSoundMgr.jp_lock);
m.active = !0;
var h = m.getComponent(sp.Skeleton);
h.setAnimation(0, "animation" + (4 - a) + "_1", !1);
h.setCompleteListener(function() {
h.setCompleteListener(null);
m.active = !1;
});
}
l.getComponent(cc.Label).font = cc.vv.gameData.GetFontByName("theme228_base2");
...
m.active = !0;
var f = m.getComponent(sp.Skeleton);
f.setAnimation(0, "animation" + (4 - a) + "_2", !1);
f.setCompleteListener(function() {
f.setCompleteListener(null);
m.active = !1;
});
}
l.getComponent(cc.Label).font = cc.vv.gameData.GetFontByName("theme228_base1");
c.getComponent("ImgSwitchCmp").setIndex(0);
u.active = !0;
}
}
}
...
if (a) for (var i = 1; i < o.length; i++) {
var s = o[i], r = cc.find("tips_" + s, a.node.parent);
if (r) if (e === i) if (t) {
cc.find("lock", r).active = !0;
cc.find("unlock", r).active = !1;
r.scale = 0;
r.stopAllActions();
cc.tween(r).to(.5, {
scale: 1
...
cc.find("lock", r).active = !1;
cc.find("unlock", r).active = !0;
r.scale = 0;
r.stopAllActions();
cc.tween(r).to(.5, {
scale: 1
...
GenghisKhan_Slots: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "813009Io9ZMn6ad7UUvsMP4", "GenghisKhan_Slots");
function o(e) {
...
this.clearSlots();
this.scheduleOnce(function() {
e.node.y = -900 - cc.winSize.height / 2;
var t = -cc.winSize.height / 2 + 189;
...
e.node.y = -cc.winSize.height / 2 + 189;
});
},
hide: function() {
this.node.active = !1;
...
StartMove: function() {
"slots" === this.node.name && (this._normalSpine.getComponent(cc.Button).interactable = !1);
...
startBonusMove: function(e) {
this._gameInfo.resultCards = Global.copy(e.resultCards);
this._gameInfo.winCoin = Global.copy(e.winCoin);
this._gameInfo.zjLuXian = Global.copy(e.zjLuXian);
e.jackpot ? this._gameInfo.jackpot = Global.copy(e.jackpot) : this._gameInfo.jackpot = null;
this._gameInfo.jackpotValues = Global.copy(e.jackpotValues);
this._gameInfo.randWildIdxs = Global.copy(e.randWildIdxs);
this._gameInfo.bonusGame = null;
Global.SlotsSoundMgr.playNormalBgm();
this.MoveReels(this._reels);
var t = this._gameInfo.resultCards;
...
showJackpotWinEffect: function(e) {
if (!(e < 0)) {
var t = cc.find("Canvas/safe_node").getComponentInChildren("LMSlotMachine_PrizePool");
if (t) {
var n = c[e], o = cc.find("prizePool_" + n, t.node.parent);
if (o) {
var a = o.getChildByName("winEffect");
if (a) {
...
var o = this;
return new Promise(function() {
var a = r(regeneratorRuntime.mark(function a(i, s) {
...
var n, o, a, i, s, r, c, l, u, m, h, f, _, d, p, g, v, S, b, w, y, G;
return regeneratorRuntime.wrap(function(t) {
for (;;) switch (t.prev = t.next) {
case 0:
e._bottomScript.ShowBtnsByState("moveing_1");
e._stayNode.removeAllChildren();
e._mask.stopAllActions();
e._mask.active = !1;
e._chufaFreeGame = !1;
e._bonuskuang.active = !1;
if (!(e._gameInfo.randWildIdxs && e._gameInfo.randWildIdxs.length > 0)) {
t.next = 19;
break;
}
n = 0;
...
case 8:
if (!(n < e._gameInfo.randWildIdxs.length)) {
t.next = 17;
break;
}
o = e._gameInfo.randWildIdxs[n];
(a = e.GetSymbolByIdx(o)) && a.changeWild();
t.next = 14;
return e.awaitTime(.2);
...
e.showJackpotWinEffect(e._gameInfo.jackpot.id - 1);
t.next = 23;
return cc.vv.gameData.getPopWinManage().showJackpotWinCoin(e._gameInfo.jackpot.value, e._gameInfo.jackpot.id);
...
i -= e._gameInfo.bonusGame.winCoin;
s -= e._gameInfo.bonusGame.winCoin;
r = !1;
}
if (e._isInFree || !e._bonusSpin) {
t.next = 36;
break;
}
c = e._bottomScript.getCurrentWin() + cc.vv.gameData.GetGameWin();
l = c;
t.next = 34;
return e.ShowWinCoin(c, l, !0);
...
for (u = 0; u < e._reels.length; u++) {
m = e._reels[u];
for (h = 0; h < m._symbols.length; h++) {
(f = m._symbols[h]).ShowNormal();
f.ShowKuang(!1);
}
}
cc.vv.gameData.getManage().PausePool(e._gameInfo.bonusGame.jackpotValues);
if (!(_ = e.GetSymbolByIdx(e._gameInfo.bonusGame.bonusIdx))) {
t.next = 49;
break;
}
_.playTriggerAnimation();
t.next = 48;
...
case 62:
e._bonuskuang.active = !0;
e._gameInfo.bonusGame.lockSymbols.length > 0 && Global.SlotsSoundMgr.playEffect(Global.SlotsSoundMgr.bonus_lock);
for (d = 0; d < e._gameInfo.bonusGame.lockSymbols.length; d++) {
p = e._gameInfo.bonusGame.lockSymbols[d];
(g = e.GetSymbolByIdx(p.idx)) && g.showSuo();
}
if (!_) {
t.next = 68;
break;
...
case 68:
cc.vv.gameData.getBonus().showBonus(_._reelIdx, e._gameInfo.bonusGame.wheels, e.OnSpinEnd.bind(e), e._gameInfo.bonusGame.stopIdx - 1);
t.next = 71;
return e.awaitTime(1.3);

case 71:
e.startBonusMove(e._gameInfo.bonusGame);
...
for (v = 0; v < e._gameInfo.freeResult.freeInfo.scatterIdx.length; v++) {
S = e._gameInfo.freeResult.freeInfo.scatterIdx[v];
(b = e.GetSymbolByIdx(Number(S))) && b.playWinAnimation();
}
...
for (w = 0; w < e._gameInfo.freeResult.freeInfo.scatterIdx.length; w++) {
y = e._gameInfo.freeResult.freeInfo.scatterIdx[w];
(G = e.GetSymbolByIdx(Number(y))) && G.playWinAnimation();
}
if (!(e._gameInfo.freeResult.freeInfo.freeCnt > 0)) {
t.next = 99;
break;
...
case 94:
cc.vv.gameData.getCollectNode().addPoint(e._gameInfo.freeResult.freeInfo.scatterIdx);
t.next = 97;
return e.awaitTime(1);
...
t.next = 5;
return cc.vv.gameData.getPopWinManage().showSuperBonusWinCoin(a);
...
var t = cc.find("Canvas/safe_node/spr_bg_normal"), n = cc.find("Canvas/safe_node/spr_bg_free"), o = cc.find("Canvas/safe_node/spr_bg_superBonus");
t && (t.active = !e);
if (cc.vv.gameData.getCollectNode().isSuperBonus()) {
o.active = e;
n.active = !1;
...
cc.vv.gameData.getCollectNode().isSuperBonus() && this._bottomScript.showTotalBet(!1);
} else {
...
showFreeGameEffect: function(e, t, n) {
var o = this;
this.node.runAction(cc.shake(e, t, n));
this._kuangFree.active = !0;
this.scheduleOnce(function() {
o._kuangFree.active = !1;
}, e + .5);
},
DoCheckReelAnti: function(e) {
if (!this._bStopRightnow && !this._chufaFreeGame) for (var t = !1, n = 0; n < this._reels.length; n++) {
var o = this._reels[n].GetReelIdx();
o == e + 1 && (t = this._reels[n].playAntiAnimation());
if (o > e && t) {
...
for (;;) switch (t.prev = t.next) {
case 0:
(o = cc.instantiate(cc.vv.gameData.GetPrefabByName("m1za"))).parent = cc.vv.gameData.getManage()._collectFree;
a = Global.random(1, 40);
if (i = e.GetSymbolByIdx(a)) {
Global.SlotsSoundMgr.playEffect(Global.SlotsSoundMgr.wild_add);
s = i.node.convertToWorldSpaceAR(cc.v2(0, 0));
r = cc.vv.gameData.getManage()._collectFree.convertToNodeSpaceAR(s);
o.position = r;
(c = o.getComponent(sp.Skeleton)).setAnimation(0, "animation", !1);
c.setCompleteListener(function() {
o.parent = null;
c.setCompleteListener(null);
});
l = e._reels[i._reelIdx];
o.y += Math.abs(l._curY);
}
t.next = 7;
return e.awaitTime(.1);
...
n.isStop = !1;
n.isAnt = !1;
for (var o = n.mini, i = Global.copy(n.counts), s = 0, r = !0, u = 0; u < a.length; u++) {
var m = t._reels[u], h = a[u];
n.isStop = !1;
n.isAnt = !1;
...
s += f;
i.shift();
var _ = (i.length > 0 ? i.reduce(function(e, t) {
return e + t;
}) : 0) + s;
if (f > 0 && _ >= o && r) {
n.isStop = !0;
...
n.continuous && n.counts[u] > 0 && 0 == f && (r = !1);
m.AddReelStateInfo(Global.copy(n));
}
};
for (u.s(); !(c = u.n()).done; ) m();
} catch (e) {
u.e(e);
} finally {
u.f();
...
GenghisKhan_bounsReel: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "cb8acXeKj5AHrZw4yNVSzJ2", "GenghisKhan_bounsReel");
cc.Class({
extends: cc.Component,
properties: {
_reelIdx: 0,
...
var e = Global.random(0, this._cfg.randomSymbols_bonus.length - 1), t = this._cfg.randomSymbols_bonus[e];
this._randomVal = t;
...
var o = this._bg.getComponent(sp.Skeleton);
o.setAnimation(0, "animation2", !1);
o.addAnimation(0, "animation3", !0);
...
this._result = e;
this._backReuslt = [];
for (var n = t; n < e.length; n++) this._backReuslt.push(e[n]);
},
startSpin: function() {
0 == this._symbols.length && this.updateSymbol();
this._stopTime = 4.5;
this._bMoveing = !0;
this._moveSpeed = 1600;
Global.SlotsSoundMgr.playEffect(Global.SlotsSoundMgr.bonus_roll);
},
update: function(e) {
this._stopTime -= e;
if (this._bMoveing && this._symbols.length > 0) {
for (var t = this._moveSpeed * e, n = 0; n < this._symbols.length; n++) {
this._symbols[n].node.y -= t;
}
this._moveLength += t;
...
if (this._stopTime <= 0) {
this._moveSpeed -= 680 * e;
this._moveSpeed < 150 && (this._moveSpeed = 150);
}
},
updateSymbol: function() {
var e = this, t = null;
this._symbols[0] && this._symbols[0].node.y <= -this._cfg.symbolSize.height / 2 && (t = this._symbols.shift());
if (!t) {
(t = cc.instantiate(cc.vv.gameData.GetPrefabByName(this._cfg.symbolPrefab)).addComponent(this._cfg.scripts.Symbols)).node.parent = this._mask;
}
var n = this.randomVal(), o = null;
if (this._bMoveing && this._stopTime <= 2 && !(o = this._result.shift())) {
this._bMoveing = !1;
var a = this._holder.y - this._cfg.symbolSize.height / 2 - this._symbols[0].node.y, i = -a / this._moveSpeed;
i < 0 && (i = 0);
for (var s = 0; s < this._symbols.length; s++) {
var r = this._symbols[s], c = r.node.y + a;
cc.tween(r.node).to(i, {
y: c
}).start();
}
this.scheduleOnce(function() {
...
o && (n = o);
t.ShowById(n);
this._symbols.length > 0 ? t.node.y = this._symbols[this._symbols.length - 1].node.y + this._cfg.symbolSize.height : t.node.y = this._mask.height + this._cfg.symbolSize.height / 2 + this._holder.y;
this._symbols.push(t);
},
hideAnimation: function() {
var e = this, t = this._bg.getComponent(sp.Skeleton);
t.setAnimation(0, "animation4", !1);
t.setCompleteListener(function() {
e.hide();
t.setCompleteListener(null);
});
for (var n = 0; n < this._symbols.length; n++) {
var o = this._symbols[n];
cc.tween(o.node).to(.5, {
opacity: 0
}).start();
}
for (var a = 0; a < this._backReuslt.length; a++) {
var i = this._backReuslt[a], s = cc.vv.gameData.GetSlotsScript()._reels[this._reelIdx - 1]._symbols[a];
s && s.ShowById(i);
}
...
GenghisKhan_bouns: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "3e847C/iiBHKYE5rm4IDBJx", "GenghisKhan_bouns");
cc.Class({
extends: cc.Component,
properties: {
_reels: []
...
onLoad: function() {
for (var e = 1; e < 6; e++) {
var t = cc.find("reels/reel" + e, this.node).addComponent("GenghisKhan_bounsReel");
this._reels.push(t);
t.init(e);
}
},
start: function() {},
showBonus: function(e, t, n, o) {
for (var a = 0; a < this._reels.length; a++) {
this._reels[a].hide();
}
this._reels[e].show(t, n, o);
}
});
cc._RF.pop();
}, {} ],
GenghisKhan_manage: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "c81a094z+xCBYGekeLJTTzw", "GenghisKhan_manage");
function o(e, t, n, o, a, i, s) {
try {
var r = e[i](s), c = r.value;
} catch (e) {
...
onClickTianMa: function() {
var e = this;
this._tianma.getComponent(cc.Button).interactable = !1;
var t = this._tianma.getComponent(sp.Skeleton);
...
this.scheduleOnce(function() {
e._tianma.getComponent(cc.Button).interactable = !0;
}, 3);
},
awaitTime: function(e) {
var t = this;
...
if (0 == e) {
t._tianma.active = !0;
t._tianma.opacity = 255;
} else cc.tween(t._tianma).delay(.5).to(.5, {
opacity: 0
}).call(function() {
t._tianma.active = !1;
}).start();
...
recoverySlot: function(e) {
if (0 == e) {
this._tianma.active = !0;
this._tianma.opacity = 255;
} else this._tianma.active = !1;
cc.vv.gameData.setSlotsIndex(e);
...
var o = this;
return new Promise(function() {
var i = a(regeneratorRuntime.mark(function a(i, s) {
var r;
return regeneratorRuntime.wrap(function(a) {
for (;;) switch (a.prev = a.next) {
case 0:
...
o._malizi2.active = !0;
a.next = 5;
return o.awaitTime(.6);

case 5:
(r = o._tianma.getComponent(sp.Skeleton)).setAnimation(0, "animation3", !1);
r.addAnimation(0, "animation1", !0);
o._reels_frame.runAction(cc.shake(e - .5, t, n));
cc.vv.gameData.GetSlotsScript().showFreeGameEffect(e - .5, t, n);
o._prizePool.node.runAction(cc.shake(e - .5, t, n));
a.next = 13;
...
showBonusBg: function() {
this._bonusBg.active = !0;
...
cc.vv.gameData.GetSlotsScript()._isInFree ? cc.vv.gameData.getCollectNode().isSuperBonus() ? Global.SlotsSoundMgr.playBgm(Global.SlotsSoundMgr.map_bgm) : Global.SlotsSoundMgr.playBgm(Global.SlotsSoundMgr.free_bgm) : Global.SlotsSoundMgr.playNormalBgm(!0);
}
}
});
cc._RF.pop();
}, {} ],
GenghisKhan_qiePing: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "4a5b1itllZOtav0lRInw6Pd", "GenghisKhan_qiePing");
function o(e, t, n, o, a, i, s) {
try {
var r = e[i](s), c = r.value;
} catch (e) {
...
t.qiepinGD.active = !0;
(i = t.qiepinGD.getComponent(sp.Skeleton)).setAnimation(0, "animation", !1);
i.setCompleteListener(function() {
t.qiepinGD.active = !1;
o();
i.setCompleteListener(null);
...
t.qiepinQiu.active = !0;
(i = t.qiepinQiu.getComponent(sp.Skeleton)).setAnimation(0, "animation", !1);
i.setCompleteListener(function() {
t.qiepinQiu.active = !1;
o();
i.setCompleteListener(null);
});
n.next = 7;
...
GenghisKhan_reel: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "78f01w3UhBCO4NRC5+ENvII", "GenghisKhan_reel");
function o(e) {
if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
if (Array.isArray(e) || (e = a(e))) {
var t = 0, n = function() {};
...
var n, a = this._symbols[t], i = o(this._reelState);
try {
for (i.s(); !(n = i.n()).done; ) {
var s = n.value;
s.isStop && s.id.includes(a.GetShowId()) ? a.playStopAnimation() : a.playidleAnimation();
}
} catch (e) {
i.e(e);
} finally {
...
if (e && e[0]) {
var r, c = "", l = "", u = !1, m = o(this._reelState);
try {
for (m.s(); !(r = m.n()).done; ) {
var h = r.value;
if (h.isStop) {
l = h.symbolStopSound ? h.symbolStopSound : "";
u = !0;
} else c = h.reelStopSound ? h.reelStopSound : "";
}
} catch (e) {
m.e(e);
} finally {
...
cc.vv.AudioManager.playEff(f, c, !0);
}
},
...
cc.vv.AudioManager.playEff(s, i.antSound, !0);
var r = i.antSpeed;
...
try {
for (i.s(); !(a = i.n()).done; ) {
var s = a.value, r = cc.find("effect/reel" + (this._reelIdx + 1) + "/" + s.antiNode, this.node.parent);
if (r && r.active) {
r.active = !1;
...
var c = cc.find("effect/reel" + (this._reelIdx + 1) + "/node_anti", this.node.parent);
c ? c.active = e : cc.log("未找到加速节点：effect/node_anti");
}
},
...
t ? e.ShowById(t.sid, t.data) : e.ShowRandomSymbol_move();
...
GenghisKhan_sound: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "9374brEFrpDAqL9irtaif7x", "GenghisKhan_sound");
var o;
function a(e, t, n) {
t in e ? Object.defineProperty(e, t, {
value: n,
...
}, a(o, "reel_stop", "reel_stop"), a(o, "scatter_sweep", "scatter_sweep"), a(o, "shake", "shake"), 
a(o, "symbol_bonus", "symbol_bonus"), a(o, "symbol_scatter1", "symbol_scatter1"), 
a(o, "symbol_scatter2", "symbol_scatter2"), a(o, "symbol_scatter3", "symbol_scatter3"), 
a(o, "symbol_scatter4", "symbol_scatter4"), a(o, "symbol_scatter5", "symbol_scatter5"), 
a(o, "transition_free", "transition_free"), a(o, "transition_map", "transition_map"), 
a(o, "welcome", "welcome"), a(o, "bonus_bgm", "bonus_bgm"), a(o, "bonus_boom", "bonus_boom"), 
a(o, "bonus_dialog_collect_show", "bonus_dialog_collect_show"), a(o, "bonus_dialog_start_show", "bonus_dialog_start_show"), 
a(o, "bonus_lock", "bonus_lock"), a(o, "bonus_rise", "bonus_rise"), a(o, "bonus_roll", "bonus_roll"), 
a(o, "bonus_stop", "bonus_stop"), a(o, "Grand_jp_dialog_collect_show", "Grand_jp_dialog_collect_show"), 
a(o, "Major_jp_dialog_collect_show", "Major_jp_dialog_collect_show"), a(o, "MINOR_jp_dialog_collect_show", "MINOR_jp_dialog_collect_show"), 
a(o, "random_wild", "random_wild"), a(o, "free_bgm", "free_bgm"), a(o, "free_dialog_collect_show", "free_dialog_collect_show"), 
a(o, "free_dialog_start_show", "free_dialog_start_show"), a(o, "free_retrigger_dialog_start_show", "free_retrigger_dialog_start_show"), 
a(o, "free_rise", "free_rise"), a(o, "map_bgm", "map_bgm"), a(o, "mapfree_dialog_collect_show", "mapfree_dialog_collect_show"), 
a(o, "mapfree_dialog_start_show", "mapfree_dialog_start_show"), a(o, "wild_add", "wild_add"), 
o)
});
cc._RF.pop();
}, {
...
GenghisKhan_symbol: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "fe027G97MFA755YEAByrqVO", "GenghisKhan_symbol");
cc.Class({
...
if (3 === e._id) {
var o = cc.instantiate(e.node);
o.parent = cc.vv.gameData.GetSlotsScript()._stayNode;
o.active = !0;
var a = e.node.convertToWorldSpaceAR(cc.v2(0, 0)), i = cc.vv.gameData.GetSlotsScript()._stayNode.convertToNodeSpaceAR(a);
o.position = i;
var s = cc.find("w14", o);
s.active = !0;
s.getComponent(sp.Skeleton).setAnimation(0, "animation3", !0);
e.scheduleOnce(function() {
Global.SlotsSoundMgr.playEffect(Global.SlotsSoundMgr.bonus_boom);
var e = cc.find("zhaqiu", o);
e.active = !0;
...
if (a) {
a.setAnimation(0, t.symbol[e].stop_ani.name, !1);
t.symbol[e].idle_ani && a.addAnimation(0, t.symbol[e].idle_ani.name, !0);
}
}
}
},
...
e = !0;
var i = a.getComponent(sp.Skeleton);
i && i.setAnimation(0, n.symbol[t].idle_ani.name, !0);
}
}
return e;
},
showSuo: function() {
var e = this._id, t = cc.vv.gameData.getGameCfg(), n = cc.instantiate(this.node);
n.parent = cc.vv.gameData.GetSlotsScript()._stayNode;
n.active = !0;
var o = this.node.convertToWorldSpaceAR(cc.v2(0, 0)), a = cc.vv.gameData.GetSlotsScript()._stayNode.convertToNodeSpaceAR(o);
n.position = a;
cc.find(t.symbol[e].node, n).active = !0;
var i = cc.find("suo2", n);
i.active = !0;
...
ShowRandomSymbol_move: function() {
var e = cc.vv.gameData.getGameCfg(), t = Global.random(1, e.randomSymbols_move.length), n = e.randomSymbols_move[t - 1];
this.ShowById(n);
}
});
cc._RF.pop();
