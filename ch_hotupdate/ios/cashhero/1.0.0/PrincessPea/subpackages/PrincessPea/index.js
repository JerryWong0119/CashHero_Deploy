  ...
  PrincessPea_FreeGame: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      genBonusSymbols: function genBonusSymbols() {
        ...
        this._symbolArr = [];
        bonusInfo = Array.isArray(bonusInfo) ? bonusInfo : bonusInfo && "object" === _typeof(bonusInfo) ? Object.values(bonusInfo) : [];
  ...
  PrincessPea_Slots: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      SetSlotsResult: function SetSlotsResult(cards) {
        ...
        if (progressData && progressData.currIdxs) {
          var pd = [];
          Array.isArray(progressData.currIdxs) && (pd = progressData.currIdxs);
          pd.forEach(function(idx) {
