  ...
  Zues_Slots: [ function(require, module, exports) {
    ...
    cc.Class({
        ...
        return _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
             ...
             case 5:
              jpWin = 0;
              if (!(_this2._gameInfo && _this2._gameInfo.jackpot && _this2._gameInfo.jackpot.jackpotId > 1)) {
                _context2.next = 10;
                break;
              }
      ...
      setRemainFramesByBet: function setRemainFramesByBet(bet, isFree) {
        ...
        for (var i = 0; i < this._remainFramesList.length; i++) {
          var arr = Array.isArray(list) ? list : [];
          -1 !== arr.indexOf(i + 1) ? this.setRemainFrameState(i + 1, "idle") : this.setRemainFrameState(i + 1, "hide");
        }
      },
            ...
            while (1) switch (_context11.prev = _context11.next) {
             ...
             case 6:
              ...
              spine_hit.getComponent(sp.Skeleton).setCompleteListener(function() {
                ...
                var hsl = [];
                Array.isArray(_this7._hitSdList) && (hsl = _this7._hitSdList);
                _this7._hitSdList.splice(hsl.indexOf(idx), 1);
                spine_hit.destroy();
              });
