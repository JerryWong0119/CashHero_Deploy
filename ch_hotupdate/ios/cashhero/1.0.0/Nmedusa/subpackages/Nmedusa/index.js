  ...
  Nmedusa_BonusGame: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      initData: function initData(data) {
        ...
        var fb = [];
        Array.isArray(this._finishBonusData) && (fb = this._finishBonusData);
        var _iterator = _createForOfIteratorHelper(fb), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            var bonusData = _step.value;
            var bd = [];
            Array.isArray(bonusData.reelData) && (bd = bonusData.reelData);
            var _iterator2 = _createForOfIteratorHelper(bd), _step2;
            try {
             ...
             case 0:
              return _context3.abrupt("return", new Promise(function() {
                var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(sucess, failed) {
                  var multIndexs, rowIndexs, multNum, rowNum, isHave, bonusData, i, multIndex, _i, rowIndex, fbd, _iterator3, _step3, _bonusData;
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                     ...
                     case 29:
                      fbd = [];
                      Array.isArray(_this3._finishBonusData) && (fbd = _this3._finishBonusData);
                      _iterator3 = _createForOfIteratorHelper(fbd);
                      try {
             ...
             case 0:
              return _context5.abrupt("return", new Promise(function() {
                var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(sucess, failed) {
                  var atlas, idx, _iterator4, _step4, _loop;
                  return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) switch (_context4.prev = _context4.next) {
                     case 0:
                      atlas = cc.vv.gameData.GetAtlasByName("base");
                      idx = [];
                      Array.isArray(indexs) && (idx = indexs);
                      _iterator4 = _createForOfIteratorHelper(idx);
                      try {
             ...
             case 0:
              return _context8.abrupt("return", new Promise(function() {
                var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(sucess, failed) {
                  var bonusInfo, spineNode, animation, fb, _iterator5, _step5, bonusData, bd, _iterator6, _step6, reelData, row, col, symbol;
                  return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) switch (_context7.prev = _context7.next) {
                     ...
                     case 13:
                      fb = [];
                      Array.isArray(_this6._finishBonusData) && (fb = _this6._finishBonusData);
                      _iterator5 = _createForOfIteratorHelper(fb);
                      try {
                        for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
                          bonusData = _step5.value;
                          bd = [];
                          Array.isArray(bonusData.reelData) && (bd = bonusData.reelData);
                          _iterator6 = _createForOfIteratorHelper(bd);
                          try {
             ...
             case 0:
              return _context10.abrupt("return", new Promise(function() {
                var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(sucess, failed) {
                  var tempBonusData, fbd, _iterator7, _step7, bonusData, bd, _iterator9, _step9, reelData, col, bonusInfo, td, _iterator8, _step8, _reelData, row, _col, symbol, currentCoin;
                  return regeneratorRuntime.wrap(function _callee9$(_context9) {
                    while (1) switch (_context9.prev = _context9.next) {
                     case 0:
                      tempBonusData = [];
                      fbd = [];
                      Array.isArray(_this7._finishBonusData) && (fbd = _this7._finishBonusData);
                      _iterator7 = _createForOfIteratorHelper(fbd);
                      try {
                        for (_iterator7.s(); !(_step7 = _iterator7.n()).done; ) {
                          bonusData = _step7.value;
                          bd = [];
                          Array.isArray(bonusData.reelData) && (bd = bonusData.reelData);
                          _iterator9 = _createForOfIteratorHelper(bd);
                          try {
                            for (_iterator9.s(); !(_step9 = _iterator9.n()).done; ) {
                              reelData = _step9.value;
                              col = (reelData.index - 1) % _this7._col;
                              col > 0 && col < 4 && tempBonusData.push(reelData);
                            }
                          } catch (err) {
                            _iterator9.e(err);
                          } finally {
                      ...
                      td = [];
                      Array.isArray(tempBonusData) && (td = tempBonusData);
                      _iterator8 = _createForOfIteratorHelper(td);
                      _context9.prev = 10;
                      _iterator8.s();
                     ...
                     case 12:
                      ...
                      row = _this7._row - Math.floor((_reelData.index - 1) / _this7._col) - 1;
                      _col = (_reelData.index - 1) % _this7._col;
                      symbol = _this7.getSymbolTopAni(row, _col);
                      if (symbol) {
                        symbol.ShowById(TypeID[_reelData.type], _reelData.coin);
                        symbol.setMult(bonusInfo.addMult);
                        symbol.setBonusMaskVisible(true);
                      }
                      _this7.playBaoAnimation(row, _col);
                      if (!(_reelData.type >= 1 && _reelData.type <= 5)) {
                        _context9.next = 24;
                        break;
                      }
                      _context9.next = 22;
                      return cc.vv.gameData.getPopControl().showJackpotWinCoin(_reelData.type, bonusInfo.addMult, _reelData.coin);
                     ...
                     case 24:
                      _context9.next = 26;
                      return _this7.playCollectAnimation(row, _col);

                     case 26:
                      currentCoin = _this7._bottomScript.getCurrentWin();
                      _this7._bottomScript.ShowWin(currentCoin + _reelData.coin, .8, null, null);
      ...
      creatReelData: function creatReelData(resultData) {
        ...
        var rd = [];
        Array.isArray(resultData) && (rd = resultData);
        var _iterator10 = _createForOfIteratorHelper(rd), _step10;
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done; ) {
            var _info = _step10.value;
      ...
      OnSpinEnd: function OnSpinEnd() {
        ...
        return _asyncToGenerator(regeneratorRuntime.mark(function _callee13() {
          var multIndexs, rowIndexs, i, multIndex, _i3, rowIndex;
          return regeneratorRuntime.wrap(function _callee13$(_context13) {
            while (1) switch (_context13.prev = _context13.next) {
             ...
             case 15:
              ...
              rowIndex = rowIndexs[_i3];
              _context13.next = 19;
              return _this10.updateRows(_this10._bonusData.addRow - _i3, [ rowIndex ]);
    ...
    cc.Class({
      ...
      ShowAntiEffect: function ShowAntiEffect(bShow, name) {
        ...
        if (true === bShow) {
          ...
          _node ? _node.active = true : console.log(">>>> \u672a\u627e\u5230\u52a0\u901f\u8282\u70b9\uff1amask/node_anti");
        }
      }
    });
    cc._RF.pop();
  ...
  Nmedusa_Slots: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      SetSlotsResult: function SetSlotsResult(cards) {
        ...
        var bonusList = [];
        Array.isArray(this._gameInfo.roundBonus) ? bonusList = this._gameInfo.roundBonus : this._gameInfo.roundBonus && "object" === _typeof(this._gameInfo.roundBonus) && (bonusList = Object.values(this._gameInfo.roundBonus));
        var _iterator = _createForOfIteratorHelper(bonusList), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
