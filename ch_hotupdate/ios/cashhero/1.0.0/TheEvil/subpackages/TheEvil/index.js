    ...
    cc.Class({
      ...
      showMask: function showMask() {
        ...
        if (this._gameInfo.bubbleInfo && this._gameInfo.bubbleInfo.length > 0) {
          console.log(">>>> type: ", _typeof(this._gameInfo.bubbleInfo));
          var bi = [];
          Array.isArray(this._gameInfo.bubbleInfo) && (bi = this._gameInfo.bubbleInfo);
          "object" === _typeof(this._gameInfo.bubbleInfo) && (bi = Object.values(this._gameInfo.bubbleInfo || {}));
          var _iterator = _createForOfIteratorHelper(bi), _step;
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              var info = _step.value;
              console.log(">>>> info type: ", _typeof(info.points));
              var p = [];
              Array.isArray(info.points) && (p = info.points);
              "object" === _typeof(info.points) && (p = Object.values(info.points || {}));
              var _iterator2 = _createForOfIteratorHelper(p), _step2;
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
      ...
      OnSpinEnd: function OnSpinEnd() {
        var _this2 = this;
        return _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
          var points, bi, _iterator3, _step3, info, p, _iterator4, _step4, idx, nWin, currentCoin, bonusWinCoin;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
             case 0:
              ...
              points = [];
              bi = [];
              Array.isArray(_this2._gameInfo.bubbleInfo) && (bi = _this2._gameInfo.bubbleInfo);
              "object" === _typeof(_this2._gameInfo.bubbleInfo) && (bi = Object.values(_this2._gameInfo.bubbleInfo || {}));
              _iterator3 = _createForOfIteratorHelper(bi);
              try {
                for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
                  info = _step3.value;
                  p = [];
                  Array.isArray(info.points) && (p = info.points);
                  "object" === _typeof(info.points) && (p = Object.values(info.points || {}));
                  _iterator4 = _createForOfIteratorHelper(p);
                  try {
                    for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
                      idx = _step4.value;
