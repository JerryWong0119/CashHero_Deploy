             ...
             case 0:
              return _context6.abrupt("return", new Promise(function() {
                var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(success) {
                  var haveSuper, items, _iterator2, _step2, item, _iterator3, _step3, subItem, symbol, _iterator4, _step4, _subItem, _symbol;
                  return regeneratorRuntime.wrap(function _callee5$(_context5) {
                    while (1) switch (_context5.prev = _context5.next) {
                     case 0:
                      haveSuper = false;
                      items = _this5._gameInfo.bonusInfo.items;
                      items = Array.isArray(items) ? items : items && "object" === _typeof(items) ? Object.values(items) : [];
