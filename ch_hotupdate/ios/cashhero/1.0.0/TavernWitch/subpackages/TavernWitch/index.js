  ...
  TavernWitch_JPGame: [ function(require, module, exports) {
    ...
    cc.Class({
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
             ...
             case 2:
              ...
              ci = SlotsFacade && SlotsFacade.dm && SlotsFacade.dm.jackpotGame && SlotsFacade.dm.jackpotGame.choiceIdxs;
              Array.isArray(ci) || (ci = []);
              if (!ci.includes(bag.id)) {
                _context.next = 7;
                break;
              }
              return _context.abrupt("return");
      ...
      _randomBagSpineAni: function _randomBagSpineAni() {
        var _this7 = this;
        return _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
          var jpData, restIdx, ci, i, len, _i2, temp, idx, count, _i3, bag;
          return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) switch (_context7.prev = _context7.next) {
             case 0:
