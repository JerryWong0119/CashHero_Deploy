    ...
    cc.Class({
      ...
      ShowAntiEffect: function ShowAntiEffect(bShow, name) {
        if (false === bShow) {
          ...
          _node2 ? _node2.active = bShow : console.log("\u672a\u627e\u5230\u52a0\u901f\u8282\u70b9\uff1amask/node_anti");
        }
      },
                  ...
                  return regeneratorRuntime.wrap(function _callee8$(_context8) {
                    while (1) switch (_context8.prev = _context8.next) {
                     case 0:
                      ...
                      console.log(_this8._wheelCurIndex);
                      console.log(angle);
             ...
             case 3:
              ...
              for (i = 0; i < data.scatterIdxs.length; i++) {
                ...
                if (scatterIdx !== data.choiceId) {
                  ...
                  tujiatlas.getSpriteFrame("theme173_s_fpr" + data.allOptions[i] + "n") ? _icon.getComponent(cc.Sprite).spriteFrame = tujiatlas.getSpriteFrame("theme173_s_fpr" + data.allOptions[i] + "n") : _icon.getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame("theme173_s_fpr" + data.allOptions[i]);
                  _icon.active = true;
                  _icon.scale = 0;
                }
              }
              ...
              tujiatlas.getSpriteFrame("theme173_s_fpr" + data.choiceType + "n") ? icon.getComponent(cc.Sprite).spriteFrame = tujiatlas.getSpriteFrame("theme173_s_fpr" + data.choiceType + "n") : icon.getComponent(cc.Sprite).spriteFrame = atlas.getSpriteFrame("theme173_s_fpr" + data.choiceType);
              icon.active = true;
              icon.scale = 0;
