    ...
    cc.Class({
      ...
      initAllItems: function initAllItems() {
        for (var i = 0; i < this._itemList.length; i++) {
          ...
          var choiceIdxs = Object.values(this._jackpotGame.choiceIdxs || {}).filter(function(v) {
            return "number" === typeof v;
          });
          var results = this._jackpotGame.results;
          var type = void 0;
          var ci = [];
          Array.isArray(choiceIdxs) && (ci = choiceIdxs);
          type = ci && ci.includes(i + 1) ? results[ci.indexOf(i + 1)] : itemType.none;
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
               case 0:
                ...
                _this._choiceIdxs = Object.values(_this._jackpotGame.choiceIdxs || {}).filter(function(v) {
                  return "number" === typeof v;
                });
                _this._curCnt = _this._choiceIdxs.length;
                _this.initTit();
                _this.initWinItems();
                _this.initAllItems();
      ...
      onClickItem: function onClickItem(event) {
        ...
        if (this._choiceIdxs.includes(idx) || Object.values(this._jackpotGame.choiceIdxs || {}).filter(function(v) {
          return "number" === typeof v;
        }).includes(idx)) return;
        this._curCnt += 1;
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
             ...
             case 14:
              ...
              choiceIdxs = Object.values(_this4._jackpotGame.choiceIdxs || {}).filter(function(v) {
                return "number" === typeof v;
              });
