  ...
  Interstellar_Slots: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      SetSlotsResult: function SetSlotsResult(msg) {
        ...
        bonusCoinIdxs = Array.isArray(bonusCoinIdxs) ? bonusCoinIdxs : bonusCoinIdxs && "object" === _typeof(bonusCoinIdxs) ? Object.values(bonusCoinIdxs) : [];
        bonusCoinIdxs = bonusCoinIdxs.concat();
        var bonusCoins = SlotsFacade.dm.getSpinData().bonusCoins || [];
        bonusCoins = Array.isArray(bonusCoins) ? bonusCoins : bonusCoins && "object" === _typeof(bonusCoins) ? Object.values(bonusCoins) : [];
