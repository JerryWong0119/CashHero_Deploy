...
static AAAA_DeviceInfo_BBBB *instance=NULL;

@implementation AAAA_DeviceInfo_BBBB 

//获取单利对象
+ (id)AAAA_getInstant_BBBB {
    if (!instance) {
        instance = [[AAAA_DeviceInfo_BBBB alloc] init];
    }
    return instance;
}
...
+ (NSString *)AAAA_getPhoneModelName_BBBB{
    ...
    NSString* deviceId = nullptr;
    deviceId = [AAAA_DeviceInfo_BBBB AAAA_getPhoneModeCode_BBBB];
    NSString* deviceName = nullptr;
    deviceName = [deviceNamesByCode objectForKey:deviceId];
